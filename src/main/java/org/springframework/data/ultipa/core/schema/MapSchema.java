...
import static org.springframework.data.ultipa.core.mapping.model.UltipaSystemProperty.*;
...
class MapSchema implements Schema {
    ...
    MapSchema(Node node) {
        ...
        put(ID.getMappedName(), node.getID());
        put(UUID.getMappedName(), node.getUUID());
    ...
    MapSchema(Edge edge) {
        ...
        put(UUID.getMappedName(), edge.getUUID());
        put(FROM.getMappedName(), edge.getFrom());
        put(TO.getMappedName(), edge.getTo());
        put(FROM_UUID.getMappedName(), edge.getFromUUID());
        put(TO_UUID.getMappedName(), edge.getToUUID());
